        ...
        <div className="bg-white">
          ...
          <section className="bg-gray-800 mt-12">
            <div className="container mx-auto">
              <div className=" px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-24  text-gray-100">
                ...
                <ul className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                  <li className="flex items-center space-x-2">
                    ...
                    <span className="text-white font-semibold">Single-family homes</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="text-white font-semibold">Townhouses </span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span className="text-white font-semibold">Student housing</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="text-white font-semibold">Senior living community</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
